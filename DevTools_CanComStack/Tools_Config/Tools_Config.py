...
########################################################################
os.system('cls')
print("\n\tStart run Com Config to ISOLAR......!\n\n")
...
#Debug
# for Message in MessageList:
#     print(Message.MessageName,"\t",Message.CycleTime,"\t",Message.MessageTxNode," --> ",Message.MessageRxNode,"\t",Message.NetworkName)
#     SignalList = Message.SignalList
#     for signal in SignalList:
#         print("\t",signal)
#     print("\n")
